...
public class PantallaUpdateContactoPanel extends AbstactPantallaFormularioPanel {
    
    
    private ContactoService contactoService = new ContactoService();
    
    private Contacto contactoAModificar;
   
    public Contacto getContactoAModificar() {
        return contactoAModificar;
    }

    public void setContactoAModificar(Contacto contactoAModificarDatos) {
        this.contactoAModificar = contactoAModificarDatos;
        CamposContactosPanel c = (CamposContactosPanel) this.camposPanel; 
	c.getNombreYApellidoTxt().setText(contactoAModificar.getNombre()); 
	c.getEmailTxt().setText(contactoAModificar.getEmail());
	c.getTelefonoTxt().setText(contactoAModificar.getTelefono());
    }

    public PantallaUpdateContactoPanel(PanelManager panelManager) 
    { 
	super(panelManager); 
	...
	llenarDatos();
	try {
	Validations.isEmailBasicValidation(contactoAModificar.getEmail());
	Validations.NotIsVoid(contactoAModificar.getNombre());
	vaciarCampos();
	contactoService.modificarContacto(contactoAModificar);
	...
	contactoAModificar.setNombre(nombreIngresado);
	contactoAModificar.setEmail(emailIngresado);
	contactoAModificar.setTelefono(telefonoIngresado);
